...
// paragrafoTeste.innerText = 'Primeira mudança utilizando js';


/*let counter = 0;
setInterval(() => {
    paragrafoTeste.innerHTML = '<strong>Contador:</strong> ' + counter;
    counter++;
},1000);*/

/*setInterval(() => {
    paragrafoTeste.innerText = '<strong>Contador:</strong> ' + counter;
    counter++;
},1000);*/
...
function mudaCorParaPreto(){
    paragrafoTeste.style.color = 'Black';
}
